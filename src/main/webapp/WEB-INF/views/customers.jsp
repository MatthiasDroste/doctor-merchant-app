...
<script
	src="https://test.ctpe.net/frontend/widget/v3/widget.js?language=en&style=card"></script>
<link rel="stylesheet"
...
<body>
	...
	<div ng-controller="CustomerCtrl">
				...
				<div style="padding-top: 10px;">
					...
					<div ng-show=" searchResultsFound()">
						...
						<div ng-repeat="customer in customers" class="search-results">
							<span class="title"> <span style="font-size: smaller"><span>#</span>{{customer.id}}</span>
								<a ng-click="load(customer)">{{customer.firstName}}
									{{customer.lastName}}</a>
							</span>
						</div>
		...
		<form class="form-horizontal" ng-submit="updateCustomer">
			<fieldset>
				<legend>
					<span class="customer-visible-{{!isCustomerLoaded()}}">
						Create New Customer </span> <span
						class="customer-visible-{{isCustomerLoaded()}}"> Update
						{{customer.firstName}} {{customer.lastName}} - {{customer.id}} </span>
				</legend>
				<div class="control-group">
					<label class="control-label" for="fn">First Name:</label>

					<div class="controls">
						<input class="input-xlarge" id="fn" type="text"
				...
				<div class="control-group">
					...
					<div class="controls">
						<input class="input-xlarge" id="ln" type="text"
	...
	<div>
		<form action="success.jsp" id="{token}">VISA MASTER PAYPAL</form>
	</div>
</body>
</html>